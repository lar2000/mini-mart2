						...
						<div class="card-sigin">
							...
							<div class="card-sigin">
								<div class="main-signup-header">
									...
									<div class="form-group">
										<label class="tag tag-rounded">Password</label> <input class="form-control"
											placeholder="ປ້ອນລະຫັດຜ່ານ" type="password" v-model="password">
									</div>
									...
									<div class="main-signin-footer mt-5">
										...
										<p style="color:black">ບໍ່ທັນມີບັນຊີຜູ້ໃຊ້ກົດລີ້ງເພື່ອ =><router-link
												to="/register"> ລົງທະບຽນ</router-link></p>
									</div>
								</div>
							</div>
						</div>
