			...
			<aside class="app-sidebar sidebar-scroll" v-if="isLoggedin">
				...
				<div class="main-sidemenu">
					...
					<ul class="side-menu">
                        ...
                        <li class="slide"> 
							<router-link class="side-menu__item" to="/store" ><span class="side-menu__label">ສະຕ໋ອກສິນຄ້າ</span></router-link>
						</li>
                        <li class="slide">
							<router-link class="side-menu__item" to="/pos" ><span class="side-menu__label">ຂາຍສິນຄ້າ POS</span></router-link>
						</li>
                        <li class="slide">
							<router-link class="side-menu__item" to="/transection" ><span class="side-menu__label">ການເຄື່ອນໄຫວ</span></router-link>
						</li>
                        <li class="slide">
							<router-link class="side-menu__item" to="/report" ><span class="side-menu__label">ລາຍງານ</span></router-link>
						</li>
