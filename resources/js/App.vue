			...
			<aside class="app-sidebar sidebar-scroll">
				...
				<div class="main-sidemenu">
					...
					<ul class="side-menu">
                        ...
                        <li class="slide"> 
							<router-link class="side-menu__item" to="/store" ><span class="side-menu__label">ສະຕ໋ອກສິນຄ້າ</span><span class="badge bg-success text-light" id="bg-side-text">1</span></router-link>
						</li>
                        <li class="slide">
							<router-link class="side-menu__item" to="/pos" ><span class="side-menu__label">ຂາຍສິນຄ້າ POS</span><span class="badge bg-success text-light" id="bg-side-text">1</span></router-link>
						</li>
                        <li class="slide">
							<router-link class="side-menu__item" to="/pos" ><span class="side-menu__label">ການເຄື່ອນໄຫວ</span><span class="badge bg-success text-light" id="bg-side-text">1</span></router-link>
						</li>
                        <li class="slide">
							<router-link class="side-menu__item" to="/pos" ><span class="side-menu__label">ລາຍງານ</span><span class="badge bg-success text-light" id="bg-side-text">1</span></router-link>
						</li>
